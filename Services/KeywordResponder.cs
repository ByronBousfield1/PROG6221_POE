...
namespace CyberAwarenessBot.Services
{
    public class KeywordResponder
    {
        ...
        private readonly List<string> continuationPhrases = new List<string>
        {
            ...
            "another tip", "next tip", "continue", "more info", "more please",
            "again", "elaborate"
        };
        ...
        public KeywordResponder()
        {
            ...
            topicResponses = new Dictionary<string, List<string>>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                {
                    "If a deal sounds too good to be true, like a 'You have won R500,000' SMS, it almost always is. Delete it.",
                    "Never send money or airtime to someone you have only met online, no matter how compelling their story is.",
                    "Watch out for romance scams on dating apps where someone quickly asks for financial help.",
                    "SMS scams often pretend to be from delivery services like the Post Office or Takealot. Do not click unexpected tracking links.",
                ...
                ["privacy"] = new List<string>
                {
                    ...
                    "Turn off location sharing on apps that do not really need it. Many apps track your location even when you are not using them."
                },
                ...
                ["malware"] = new List<string>
                {
                    ...
                    "Do not open email attachments from unknown senders, especially .exe, .zip, or .scr files.",
                ...
                {
                    "2FA adds a second lock to your accounts. Even if a hacker has your password, they cannot log in without the second code.",
                ...
                ["public wifi"] = new List<string>
                {
                    ...
                    "Turn off automatic Wi-Fi connection on your phone so it does not silently join malicious hotspots.",
                    "If you must use public Wi-Fi, stick to browsing. Never do online banking or shopping on it."
                },
                ["social media"] = new List<string>
                {
                    "Do not accept friend requests from strangers. Scammers create fake profiles to gather information for targeted attacks.",
